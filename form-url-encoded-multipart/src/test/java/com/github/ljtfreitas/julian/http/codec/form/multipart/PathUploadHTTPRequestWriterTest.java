...
class PathUploadHTTPRequestWriterTest {

    private final PathUploadHTTPRequestWriter writer = new PathUploadHTTPRequestWriter(() -> "abc1234");

    private final Path path = Attempt.run(() -> new File(getClass().getResource("/sample-file.txt").toURI()))
            .map(File::toPath)
            .prop();
    ...
    void serialize() throws IOException {
        ...
        HTTPRequestBody httpRequestBody = writer.write(path, UTF_8);
