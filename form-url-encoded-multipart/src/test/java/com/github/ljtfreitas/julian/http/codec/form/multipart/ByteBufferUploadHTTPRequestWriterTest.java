...
class ByteBufferUploadHTTPRequestWriterTest {

    private final ByteBufferUploadHTTPRequestWriter writer = new ByteBufferUploadHTTPRequestWriter(() -> "abc1234");
    ...
    void serialize() {
        ...
        HTTPRequestBody httpRequestBody = writer.write(ByteBuffer.wrap(content.getBytes()), UTF_8);
